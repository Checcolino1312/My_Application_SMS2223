        ...
        mAuth.sendPasswordResetEmail(email)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(getActivity(), "Email inviata",
        ...
        saveModifyProfileMaterialButton.setOnClickListener(new MaterialButton.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(nameProfileTextInputEditText.getText().toString().trim().isEmpty()) {
                    isFieldsError = true;
                    nameProfileTextInputEditText.setError("Empty");
                }
                if(surnameProfileEditText.getText().toString().trim().isEmpty()) {
                    isFieldsError = true;
                    surnameProfileEditText.setError("Empty");
                }
                if(emailProfileEditText.getText().toString().trim().isEmpty()) {
                    isFieldsError = true;
                    emailProfileEditText.setError("Empty");
                }
                if(!isFieldsError) {
                   ...
                   // menu.findItem(R.id.modifyProfileButtons).setVisible(true);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                databaseReference.child("picture")
                        ...
                        storageReference.getFile(file)
                                .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        ((ImageView) root.findViewById(R.id.modifyeProfilemageView))
